...
# (company_name, program_name, role_type, job_type, season, year, predicted_open_date, confidence, rolling_basis, is_official_date, source)
JOB_POSITIONS_SEED = [
    # ── US ──
    ("Goldman Sachs", "Summer Analyst", "Investment Banking", "intern", "Summer", 2026, "2026-07-01", 0.92, 0, 0, 'prediction'),
    ("Goldman Sachs", "Engineering Summer Analyst", "Software Engineering", "intern", "Summer", 2026, "2026-07-15", 0.82, 0, 0, 'prediction'),
    ("JPMorgan Chase", "Investment Banking Summer Analyst", "Investment Banking", "intern", "Summer", 2026, "2026-06-01", 0.95, 0, 0, 'prediction'),
    ("JPMorgan Chase", "Quant Summer Associate", "Quant", "intern", "Summer", 2026, "2026-07-15", 0.85, 0, 0, 'prediction'),
    ("Morgan Stanley", "Summer Analyst", "Investment Banking", "intern", "Summer", 2026, "2026-07-01", 0.90, 0, 0, 'prediction'),
    ("Morgan Stanley", "Quantitative Finance Summer", "Quant", "intern", "Summer", 2026, "2026-08-01", 0.78, 0, 0, 'prediction'),
    ("Citi", "Summer Analyst - IBD", "Investment Banking", "intern", "Summer", 2026, "2026-06-15", 0.88, 0, 0, 'prediction'),
    ("Bank of America Merrill Lynch", "Summer Analyst", "Investment Banking", "intern", "Summer", 2026, "2026-07-01", 0.85, 0, 0, 'prediction'),
    ("Evercore", "Summer Analyst", "Investment Banking", "intern", "Summer", 2026, "2026-04-15", 0.80, 0, 0, 'prediction'),
    ("Lazard", "Summer Analyst", "Investment Banking", "intern", "Summer", 2026, "2026-05-01", 0.75, 0, 0, 'prediction'),
    ("Moelis & Company", "Summer Analyst", "Investment Banking", "intern", "Summer", 2026, "2026-05-15", 0.73, 0, 0, 'prediction'),
    ("PJT Partners", "Summer Analyst", "Investment Banking", "intern", "Summer", 2026, "2026-05-01", 0.72, 0, 0, 'prediction'),
    ("Centerview Partners", "Summer Analyst", "Investment Banking", "intern", "Summer", 2026, "2026-04-15", 0.78, 0, 0, 'prediction'),
    ("Jane Street", "Quantitative Trading Intern", "Quant", "intern", "Summer", 2026, "2026-08-01", 0.90, 1, 0, 'prediction'),
    ("Jane Street", "Software Engineering Intern", "Software Engineering", "intern", "Summer", 2026, "2026-08-01", 0.85, 1, 0, 'prediction'),
    ("Citadel / Citadel Securities", "Quantitative Research Intern", "Quant", "intern", "Summer", 2026, "2026-07-15", 0.88, 1, 0, 'prediction'),
    ("Two Sigma", "Quantitative Research Intern", "Quant", "intern", "Summer", 2026, "2026-08-01", 0.82, 1, 0, 'prediction'),
    ("D.E. Shaw & Co.", "Quantitative Analyst Intern", "Quant", "intern", "Summer", 2026, "2026-07-01", 0.85, 1, 0, 'prediction'),
    ("Hudson River Trading", "Algorithm Development Intern", "Quant", "intern", "Summer", 2026, "2026-07-01", 0.88, 1, 0, 'prediction'),
    ("DRW", "Quantitative Trading Intern", "Quant", "intern", "Summer", 2026, "2026-08-01", 0.82, 1, 0, 'prediction'),
    ("Akuna Capital", "Quantitative Trading Intern", "Quant", "intern", "Summer", 2026, "2026-07-01", 0.80, 0, 0, 'prediction'),
    ("Optiver", "Quantitative Trading Intern", "Quant", "intern", "Summer", 2026, "2026-06-01", 0.85, 1, 0, 'prediction'),
    ("SIG (Susquehanna)", "Quantitative Trading Intern", "Quant", "intern", "Summer", 2026, "2026-08-01", 0.85, 1, 0, 'prediction'),
    ("Virtu Financial", "Quantitative Trading Intern", "Quant", "intern", "Summer", 2026, "2026-07-15", 0.75, 0, 0, 'prediction'),
    ("Clear Street", "Software Engineering Intern", "Software Engineering", "intern", "Summer", 2026, "2026-06-01", 0.74, 0, 0, 'prediction'),
    ("BlackRock", "Summer Analyst", "Asset Management", "intern", "Summer", 2026, "2026-08-15", 0.85, 0, 0, 'prediction'),
    ("PIMCO", "Summer Analyst", "Asset Management", "intern", "Summer", 2026, "2026-08-15", 0.80, 0, 0, 'prediction'),
    ("Bridgewater Associates", "Investment Associate Intern", "Asset Management", "intern", "Summer", 2026, "2026-07-01", 0.82, 1, 0, 'prediction'),

    # ── UK ──
    ("HSBC", "Global Banking Summer Intern", "Investment Banking", "intern", "Summer", 2026, "2026-09-01", 0.82, 0, 0, 'prediction'),
    ("Barclays", "Investment Banking Summer Analyst", "Investment Banking", "intern", "Summer", 2026, "2026-08-01", 0.85, 0, 0, 'prediction'),
    ("Rothschild & Co", "Summer Analyst", "Investment Banking", "intern", "Summer", 2026, "2026-09-01", 0.78, 0, 0, 'prediction'),
    ("Schroders", "Investment Intern", "Asset Management", "intern", "Summer", 2026, "2026-09-01", 0.75, 0, 0, 'prediction'),
    ("Baillie Gifford", "Summer Intern", "Asset Management", "intern", "Summer", 2026, "2026-09-15", 0.72, 0, 0, 'prediction'),
    ("Man Group", "Quantitative Research Intern", "Quant", "intern", "Summer", 2026, "2026-09-01", 0.78, 0, 0, 'prediction'),
    ("XTX Markets", "Quantitative Research Intern", "Quant", "intern", "Summer", 2026, "2026-09-15", 0.82, 1, 0, 'prediction'),
    ("G-Research", "Quantitative Research Intern", "Quant", "intern", "Summer", 2026, "2026-09-01", 0.80, 1, 0, 'prediction'),

    # ── CN Intern ──
    ("CITIC Securities (中信证券)", "Summer Intern - IB", "Investment Banking", "intern", "Summer", 2026, "2026-04-01", 0.85, 0, 0, 'prediction'),
    ("CITIC Securities (中信证券)", "Graduate Program - Research", "Research", "graduate", "Fall", 2026, "2026-09-01", 0.70, 0, 0, 'prediction'),
    ("CICC (中金公司)", "Summer Analyst - IB", "Investment Banking", "intern", "Summer", 2026, "2026-03-15", 0.88, 0, 0, 'prediction'),
    ("CICC (中金公司)", "Management Trainee", "Generalist", "management_trainee", "Fall", 2026, "2026-09-15", 0.72, 0, 0, 'prediction'),
    ("Huatai Securities (华泰证券)", "Quant Trading Intern", "Quant", "intern", "Summer", 2026, "2026-04-15", 0.78, 0, 0, 'prediction'),
    ("Huatai Securities (华泰证券)", "Full-Time Analyst", "Investment Banking", "full-time", "Fall", 2026, "2026-09-01", 0.65, 0, 0, 'prediction'),
    ("China Securities (中信建投)", "Summer Intern - IB", "Investment Banking", "intern", "Summer", 2026, "2026-04-01", 0.82, 0, 0, 'prediction'),
    ("China Securities (中信建投)", "Graduate Program - S&T", "Sales & Trading", "graduate", "Fall", 2026, "2026-09-15", 0.68, 0, 0, 'prediction'),
    ("Guotai Junan (国泰君安)", "Summer Intern", "Generalist", "intern", "Summer", 2026, "2026-05-01", 0.75, 0, 0, 'prediction'),
    ("Guotai Junan (国泰君安)", "Full-Time Associate", "Research", "full-time", "Fall", 2026, "2026-10-01", 0.60, 0, 0, 'prediction'),
    ("China Merchants Securities (招商证券)", "Summer Intern", "Investment Banking", "intern", "Summer", 2026, "2026-04-15", 0.77, 0, 0, 'prediction'),
    ("China Merchants Securities (招商证券)", "Graduate Program", "Asset Management", "graduate", "Fall", 2026, "2026-10-15", 0.63, 0, 0, 'prediction'),
    ("Haitong Securities (海通证券)", "Summer Analyst", "Investment Banking", "intern", "Summer", 2026, "2026-05-01", 0.73, 0, 0, 'prediction'),
    ("Haitong Securities (海通证券)", "Management Trainee", "Generalist", "management_trainee", "Fall", 2026, "2026-09-01", 0.62, 0, 0, 'prediction'),
    ("GF Securities (广发证券)", "Summer Intern", "Research", "intern", "Summer", 2026, "2026-04-15", 0.74, 0, 0, 'prediction'),
    ("GF Securities (广发证券)", "Full-Time Analyst", "Sales & Trading", "full-time", "Fall", 2026, "2026-10-01", 0.61, 0, 0, 'prediction'),
    ("Orient Securities (东方证券)", "Summer Intern", "Asset Management", "intern", "Summer", 2026, "2026-05-15", 0.70, 0, 0, 'prediction'),
    ("Orient Securities (东方证券)", "Graduate Program", "Investment Banking", "graduate", "Fall", 2026, "2026-10-01", 0.60, 0, 0, 'prediction'),
    ("Industrial Securities (兴业证券)", "Summer Intern", "Generalist", "intern", "Summer", 2026, "2026-05-01", 0.71, 0, 0, 'prediction'),
    ("Industrial Securities (兴业证券)", "Full-Time Associate", "Research", "full-time", "Fall", 2026, "2026-10-15", 0.58, 0, 0, 'prediction'),

    # ── HK Intern / Graduate ──
    ("HSBC Hong Kong (汇丰银行)", "Global Banking Summer Intern", "Investment Banking", "intern", "Summer", 2026, "2026-09-01", 0.82, 0, 0, 'prediction'),
    ("HSBC Hong Kong (汇丰银行)", "Graduate Programme - Markets", "Sales & Trading", "graduate", "Full-Year", 2026, "2026-09-15", 0.70, 0, 0, 'prediction'),
    ("Standard Chartered Hong Kong (渣打银行)", "Summer Intern - IB", "Investment Banking", "intern", "Summer", 2026, "2026-09-01", 0.78, 0, 0, 'prediction'),
    ("Standard Chartered Hong Kong (渣打银行)", "International Graduate Programme", "Generalist", "graduate", "Full-Year", 2026, "2026-09-15", 0.65, 0, 0, 'prediction'),
    ("BOCI (中银国际)", "Summer Analyst", "Investment Banking", "intern", "Summer", 2026, "2026-04-01", 0.80, 0, 0, 'prediction'),
    ("BOCI (中银国际)", "Graduate Trainee", "Generalist", "management_trainee", "Fall", 2026, "2026-10-01", 0.64, 0, 0, 'prediction'),
    ("Hang Seng Bank (恒生银行)", "Summer Intern", "Generalist", "intern", "Summer", 2026, "2026-03-01", 0.74, 0, 0, 'prediction'),
    ("Hang Seng Bank (恒生银行)", "Management Trainee Programme", "Generalist", "management_trainee", "Fall", 2026, "2026-10-01", 0.58, 0, 0, 'prediction'),
    ("Bank of East Asia (东亚银行)", "Summer Intern", "Generalist", "intern", "Summer", 2026, "2026-04-01", 0.70, 0, 0, 'prediction'),
    ("Bank of East Asia (东亚银行)", "Graduate Programme", "Generalist", "graduate", "Fall", 2026, "2026-09-15", 0.56, 0, 0, 'prediction'),
    ("HKEX (港交所)", "Summer Intern - Markets", "Sales & Trading", "intern", "Summer", 2026, "2026-03-01", 0.76, 0, 0, 'prediction'),
    ("HKEX (港交所)", "Graduate Programme", "Generalist", "graduate", "Fall", 2026, "2026-10-01", 0.60, 0, 0, 'prediction'),

    # ── EU Intern / Full-Time ──
    ("Deutsche Bank", "Summer Analyst - IBD", "Investment Banking", "intern", "Summer", 2026, "2026-07-01", 0.84, 0, 0, 'prediction'),
    ("Deutsche Bank", "Graduate Programme - FIC", "Sales & Trading", "graduate", "Fall", 2026, "2026-10-01", 0.70, 0, 0, 'prediction'),
    ("BNP Paribas", "Summer Intern - Global Markets", "Sales & Trading", "intern", "Summer", 2026, "2026-09-01", 0.80, 0, 0, 'prediction'),
    ("BNP Paribas", "Graduate Programme - CIB", "Investment Banking", "graduate", "Fall", 2026, "2026-10-15", 0.68, 0, 0, 'prediction'),
    ("Societe Generale", "Summer Analyst", "Investment Banking", "intern", "Summer", 2026, "2026-09-15", 0.76, 0, 0, 'prediction'),
    ("Societe Generale", "Full-Time Analyst - Risk", "Risk", "full-time", "Fall", 2026, "2026-10-01", 0.62, 0, 0, 'prediction'),
    ("UBS", "Summer Analyst - IBD", "Investment Banking", "intern", "Summer", 2026, "2026-08-01", 0.82, 0, 0, 'prediction'),
    ("UBS", "Graduate Talent Program", "Generalist", "graduate", "Fall", 2026, "2026-10-01", 0.70, 0, 0, 'prediction'),
    ("Credit Suisse", "Summer Analyst", "Investment Banking", "intern", "Summer", 2026, "2026-08-15", 0.72, 0, 0, 'prediction'),
    ("Credit Suisse", "Full-Time Analyst - Quant", "Quant", "full-time", "Fall", 2026, "2026-10-15", 0.58, 0, 0, 'prediction'),
    ("Barclays Europe", "Summer Analyst - IBD", "Investment Banking", "intern", "Summer", 2026, "2026-08-01", 0.78, 0, 0, 'prediction'),
    ("Barclays Europe", "Graduate Programme", "Generalist", "graduate", "Fall", 2026, "2026-10-01", 0.64, 0, 0, 'prediction'),
    ("HSBC Europe", "Summer Intern - Global Banking", "Investment Banking", "intern", "Summer", 2026, "2026-09-01", 0.76, 0, 0, 'prediction'),
    ("HSBC Europe", "Graduate Programme - Markets", "Sales & Trading", "graduate", "Fall", 2026, "2026-10-15", 0.62, 0, 0, 'prediction'),
    ("ING Group", "Summer Intern - Wholesale Banking", "Investment Banking", "intern", "Summer", 2026, "2026-09-01", 0.74, 0, 0, 'prediction'),
    ("ING Group", "International Talent Programme", "Generalist", "management_trainee", "Fall", 2026, "2026-10-01", 0.60, 0, 0, 'prediction'),

    # ── AU Intern / Graduate ──
    ("Macquarie Group", "Summer Intern - IBD", "Investment Banking", "intern", "Summer", 2026, "2026-02-01", 0.85, 0, 0, 'prediction'),
    ("Macquarie Group", "Graduate Programme - Macquarie Capital", "Investment Banking", "graduate", "Full-Year", 2026, "2026-03-01", 0.72, 0, 0, 'prediction'),
    ("Commonwealth Bank (CBA)", "Summer Intern - IB&M", "Investment Banking", "intern", "Summer", 2026, "2026-03-01", 0.78, 0, 0, 'prediction'),
    ("Commonwealth Bank (CBA)", "Graduate Programme", "Generalist", "graduate", "Full-Year", 2026, "2026-03-15", 0.68, 0, 0, 'prediction'),
    ("ANZ", "Summer Intern - Institutional", "Investment Banking", "intern", "Summer", 2026, "2026-03-15", 0.76, 0, 0, 'prediction'),
    ("ANZ", "Graduate Programme - Markets", "Sales & Trading", "graduate", "Full-Year", 2026, "2026-04-01", 0.64, 0, 0, 'prediction'),
    ("Westpac", "Summer Intern", "Generalist", "intern", "Summer", 2026, "2026-03-01", 0.72, 0, 0, 'prediction'),
    ("Westpac", "Graduate Programme", "Generalist", "graduate", "Full-Year", 2026, "2026-04-01", 0.60, 0, 0, 'prediction'),
    ("National Australia Bank (NAB)", "Summer Intern", "Generalist", "intern", "Summer", 2026, "2026-03-01", 0.70, 0, 0, 'prediction'),
    ("National Australia Bank (NAB)", "Graduate Programme", "Generalist", "graduate", "Full-Year", 2026, "2026-04-01", 0.58, 0, 0, 'prediction'),
]
...
def seed():
    ...
    for jp in JOB_POSITIONS_SEED:
        ...
        if cid:
            cursor.execute(
                "INSERT INTO job_positions (company_id, program_name, role_type, job_type, season, year, predicted_open_date, confidence, rolling_basis, is_official_date, source, status) "
                "VALUES (?,?,?,?,?,?,?,?,?,?,?,'upcoming')",
                (cid, jp[1], jp[2], jp[3], jp[4], jp[5], jp[6], jp[7], jp[8], jp[9], jp[10])
            )
